        ...
        <main id="wrapper">
          <div className="scene" id="welcome">
            <article className="content">
              ...
              <p>
                ...
                unparalleled luxury and comfort to its guests. The hotel boasts
                modern architecture and stylish design, providing a
                sophisticated atmosphere for a memorable stay. The rooms are
                spacious and well-appointed, equipped with top-of-the-line
                amenities to ensure maximum comfort. <n />
          ...
          <div className="scene" id="hotelinfo">
            ...
            <article id="usefulinfo">
              <section id="arrivalinfo">
                ...
                <ul>
                  ...
                  <li>
                    <strong>Trains:</strong> The nearest station is at Green
                    Square.
                  </li>
                  <li>
            ...
            <article id="greenprogram">
              ...
              <p>
                <strong>The Australia Hotel</strong> was recently renovated, and
                we considered the impact on the earth the entire way. From green
                building materials, to solar power, to energy-friendly lighting
                and appliances throughout the hotel - we’re saving energy in
                every socket, outlet, and switch. We’ve also initiated a
                ...
                products, or in the case of compost, for use in local gardens
                and landscapes.
              </p>
            </article>
          </div>
